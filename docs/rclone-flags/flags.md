...
```
      ...
      --cache-dir string                     Directory rclone will use for caching (default "/home/dampsock/.cache/rclone")
  ...
  -c, --checksum                             Skip based on checksum (if available) & size, not mod-time & size
      ...
      --config string                        Config file (default "/home/dampsock/.config/rclone/rclone.conf")
...
```
      ...
      --cache-chunk-path string                      Directory to cache chunk files (default "/home/dampsock/.cache/rclone/cache-backend")
      ...
      --cache-db-path string                         Directory to store file structure metadata DB (default "/home/dampsock/.cache/rclone/cache-backend")
  ...
  -L, --copy-links                                   Follow symlinks and copy the pointed to item
      ...
      --ftp-user string                              FTP username, leave blank for current username, dampsock
  ...
  -x, --one-file-system                              Don't cross filesystem boundaries (unix/macOS only)
      ...
      --sftp-user string                             SSH username, leave blank for current username, dampsock
