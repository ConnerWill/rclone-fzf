...
```
      ...
      --gid uint32                             Override the gid field set by the filesystem (not supported on Windows) (default 998)
  ...
  -o, --option stringArray                     Option for libfuse/WinFsp (repeat if required)
      ...
      --socket-gid int                         GID for unix socket (default: current process GID) (default 998)
